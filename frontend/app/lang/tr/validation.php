...
return array(
	...
	*/
	...
	"between"              => array(
		"numeric" => ":attribute alanı :min ve :max aralığında olmalıdır.",
		"file"    => ":attribute , :min ve :max kilobayt değerleri arasında olmalıdır.",
		"string"  => ":attribute , :min ve :max karakterleri arasında olmalıdır.",
		"array"   => ":attribute alanına :min ve :max adet seçim yapabilirsiniz",
	),
