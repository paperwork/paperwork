...
return array(
	...
	*/
	...
	"between"              => array(
		"numeric" => ":atribute debe estar entre :min y :max.",
		"file"    => ":atribute debe estar entre :min y :max kilobytes.",
		"string"  => ":atribute debe estar entre :min y :max caracteres.",
		"array"   => ":atribute debe estar entre :min y :max. ítems.",
	),
