angular.module('paperworkNotes', ['ngRoute', 'ngSanitize', 'ngAnimate', 'angularFileUpload', 'ab-base64', 'ngDraggable'])
...
angular.module('paperworkNotes').controller('NotesAllController',
  ['$scope', '$rootScope', '$location', '$routeParams', 'NotesService', 'ngDraggable',
   function($scope, $rootScope, $location, $routeParams, notesService, ngDraggable) {
